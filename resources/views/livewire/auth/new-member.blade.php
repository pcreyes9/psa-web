<div class="flex flex-col gap-6">
    ...
    <form wire:submit="create" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <flux:select :label="__('Civil Status')" wire:model="civil_status" placeholder="Choose your civil status">
            <flux:select.option>Single</flux:select.option>
            <flux:select.option>Married</flux:select.option>
            <flux:select.option>Widowed</flux:select.option>
            <flux:select.option>Divorced</flux:select.option>
        </flux:select>
        ...
        <div class="lg:col-span-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
            ...
            >
                @foreach ($chapters as $item)
                    <flux:select.option value="{{ $item->psa_chapter_code }}">{{ $item->psa_chapter_desc }}</flux:select.option>
        ...
        <div class="lg:col-span-3 space-y-4">
            ...
            @foreach($dependents as $index => $dependent)
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
                    ...
                    <flux:input
                        wire:model="dependents.{{ $index }}.full_name"
                        label="Full Name"
                        type="text"
                    ...
                    <flux:input
                        wire:model="dependents.{{ $index }}.relationship"
                        label="Relationship"
                        type="text"
